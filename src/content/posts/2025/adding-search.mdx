...
You can already [browse by year](./years) or [browse by tag](./tags), or peruse the [full list of articles](./) on the homepage, but I figured it would be cool to be able to search for an exact word as well.
