...
<!-- This file is adapted from an XSL file originally by Matt Webb and re-hosted and modified by Duncan Ritchie. Matt Webb’s commentary is below. -->
<!--
# Pretty Feed
      ...
      <body>
        <main>
          <header>
            ...
            <div style="background-color: var(--colour5); padding: 1px 0.75rem;">
              <p>
                This is a web feed, also known as an RSS feed. Subscribe by copying the URL from the address-bar into your newsreader.
              </p>
              <p>
                The website <a href="https://aboutfeeds.com">About Feeds</a>, by enthusiast Matt Webb, has more information on RSS.
              </p>
            </div>
